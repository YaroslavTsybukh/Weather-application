...
export const GlobalSvgSelector = ({id}: Prop) => {
    switch (id){
        case "header-logo":
            return(
                <svg
        ...
        case "Thunderstorm":
            return(
                <svg width="119" height="119" className="day-weather-icon" enable-background="new 0 0 32 32" version="1.1" viewBox="0 0 32 32"  xmlns="http://www.w3.org/2000/svg"><g id="Layer_2"/><g id="Layer_3"/><g id="Layer_4"/><g id="Layer_5"/><g id="Layer_6"/><g id="Layer_7"/><g id="Layer_8"/><g id="Layer_9"/><g id="Layer_10"/><g id="Layer_11"/><g id="Layer_12"/><g id="Layer_13"/><g id="Layer_14"/><g id="Layer_15"/><g id="Layer_16"><g><path d="M31,15c0,4.4-3.5,8.1-8.3,8.9c0,0-0.1,0-0.1,0L19.7,24H8c-3.9,0-7-3.1-7-7s3.1-7,7-7    c1.4,0,2.8,0.4,3.9,1.2C13.5,8.1,17.1,6,21,6C26.5,6,31,10,31,15z" fill="#607C8B"/></g><g><path d="M26.9,16.9l-7.2,13.6c-0.2,0.3-0.5,0.5-0.9,0.5c-0.1,0-0.2,0-0.3,0c-0.5-0.1-0.8-0.6-0.7-1.1l1.1-8.9H14    c-0.4,0-0.7-0.2-0.9-0.5c-0.2-0.3-0.2-0.7,0-1l6-10c0.2-0.4,0.7-0.6,1.1-0.5c0.4,0.1,0.7,0.5,0.7,1v5.4h5c0.3,0,0.7,0.2,0.9,0.5    S27,16.6,26.9,16.9z" fill="#FFC10A"/></g></g><g id="Layer_17"/><g id="Layer_18"/><g id="Layer_19"/><g id="Layer_20"/><g id="Layer_21"/><g id="Layer_22"/><g id="Layer_23"/><g id="Layer_24"/><g id="Layer_25"/><g id="Wearher"/></svg>
            )
        case "Drizzle":
            return(
                <svg width="119" height="119" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className="day-weather-icon">
        ...
        case "Snow":
            return(
                <svg width="119" height="119" className="day-weather-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 96 96">
                    <path d="m73.959,32.193c0,0 1.437-19.332-16.278-21.54-15.186-1.551-19.806,12.561-19.806,12.561s-4.566-4.398-10.773-.804c-5.553,3.429-4.569,9.702-4.569,9.702s-12.333,2.397-12.333,14.967c.276,12.558 13.392,12.684 13.392,12.684h48.246c0,0 12.204,.012 13.923-11.931 .813-13.062-11.802-15.639-11.802-15.639zm-44.475,41.523c3.873-5.976 2.967-6.816-2.715-2.529-1.488-6.963-2.724-6.921-3.708,.132-5.976-3.873-6.819-2.967-2.532,2.715-6.963,1.488-6.921,2.724 .132,3.711-3.873,5.973-2.964,6.816 2.718,2.529 1.485,6.963 2.721,6.921 3.708-.132 5.976,3.873 6.819,2.967 2.529-2.718 6.966-1.485 6.921-2.721-.132-3.708zm21,0c3.873-5.976 2.967-6.816-2.715-2.529-1.488-6.963-2.724-6.921-3.708,.132-5.976-3.873-6.819-2.967-2.532,2.715-6.963,1.488-6.921,2.724 .132,3.711-3.873,5.973-2.964,6.816 2.718,2.529 1.485,6.963 2.721,6.921 3.708-.132 5.976,3.873 6.819,2.967 2.529-2.718 6.966-1.485 6.921-2.721-.132-3.708zm21,0c3.873-5.976 2.967-6.816-2.715-2.529-1.488-6.963-2.724-6.921-3.708,.132-5.976-3.873-6.819-2.967-2.532,2.715-6.963,1.488-6.921,2.724 .132,3.711-3.873,5.973-2.967,6.816 2.715,2.529 1.488,6.963 2.724,6.921 3.711-.132 5.973,3.873 6.816,2.967 2.529-2.718 6.966-1.485 6.921-2.721-.132-3.708z"/>
                </svg>
            )
        case "Clear":
            return(
